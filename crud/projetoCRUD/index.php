...
<body class="min-h-screen bg-gray-200">
    ...
    ?>
    <div class="align-middle mx-80 my-12">
        <div class="grid gap-10 grid-cols-1 sm:grid-cols-2 md:grid-cols-2">
            <!--CARD 1-->
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <img src="assets/images/1.avif" alt="Imagem de Loja" class="w-full h-68 object-container">
                <div class="p-4">
            ...
            <!--CARD 2-->
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <img src="assets/images/2.jpg" alt="Imagem de Produto" class="w-full h-68 object-container">
                <div class="p-4">
                    <div class="flex flex-col space-y-4 my-2">
        ...
        <?php
        include("../projetoCRUD/includes/styles/footer.php");
        ?>
</body>
