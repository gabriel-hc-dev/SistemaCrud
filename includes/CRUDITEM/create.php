...
<div class="container mx-auto sm:px-12">
    ...
    <form action="create.php" method="post">
        <div class="mb-4"><label for="nome">Nome</label>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlInsert = "INSERT INTO produto
         (nome_produto, descricao, quantidade ) VALUES (:nome_produto, :descricao, :quantidade);";
    try {
        $statement = $conn->prepare($sqlInsert);
        $statement->bindParam(':nome_produto', $nome_produto, PDO::PARAM_STR);
